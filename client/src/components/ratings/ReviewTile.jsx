  ...
  return <tr >
    <td>
      <div className='review-elem'>
        ...
        <span className='tile-helpful'>Was this review helpful? <button disabled={helpful} onClick={handleHelpful} className='helpful-button' value='Yes'>Yes</button> ({props.review.helpfulness + (clicked ? 1 : 0)}) </span>
